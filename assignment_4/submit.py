...
def display_assignment_4_output(submission):
...
def main():
  ...
  parser.add_argument('part', choices = ['assignment_4'])
  ...
  if args.part == 'assignment_4':
    require_pledges()
    quiz = 'assignment_4'
    filenames = ["/Users/vanderson1271/assignment_4/decision_trees.py"]
  ...
  if args.part == 'assignment_4':
    display_assignment_4_output(submission)
  else:
